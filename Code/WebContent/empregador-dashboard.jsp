...
<body>
	...
	<li class="nav-link"><a class=nav-link href="search.jsp">Buscar
			diaristas!</a></li>
							...
							<tr>
								...
								<td>
									...
									<button type="button" class=" btn-danger btn-center"
										data-toggle="modal" data-target="#cancelar">Cancelar</button>
									<!-- Modal -->
									<div class="modal fade" id="cancelar" tabindex="-1"
										role="dialog" aria-labelledby="cancelarModalLabel"
										aria-hidden="true">
													...
													<div class="modal-body">
														...
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																name="SIM"> <label class="form-check-label">SIM</label>
														</div>
													</div>
								...
								<td>
									...
									<button type="button" class=" btn-primary btn-center"
										data-toggle="modal" data-target="#exampleModal">Avaliar</button>
									<!-- Modal -->
											...
											<div class="modal-content">
												...
												<form method="post" action="avaliar.jsp">
													<div class="modal-body">
														...
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																name="Ruim"> <label class="form-check-label">
																Ruim </label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																name="Regular"> <label class="form-check-label">
																Regular </label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																name="Bom"> <label class="form-check-label">
																Bom </label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																name="Muito bom"> <label
																class="form-check-label"> Muito bom </label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																name="Exelente"> <label class="form-check-label">
																Exelente </label>
														</div>
													</div>
													<div class="modal-footer">
